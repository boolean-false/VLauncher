...
PATCHED_SHA256 = "a5e1ec022d5a7ef8b9f70e0096d0cadc658ef823f7c854cf337d2c86b381af65"
...
def main() -> None:
    ...
    if sha256(patched) != PATCHED_SHA256:
        raise RuntimeError("VLauncher GTK deployment patch changed unexpectedly")
    if plugin.exists() and source != patched:
